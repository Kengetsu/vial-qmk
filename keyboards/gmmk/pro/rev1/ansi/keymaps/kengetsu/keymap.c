...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______, RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_F23,
        ...
        RESET, _______, _______,                            _______,                            _______, _______, _______, RGB_SPD, RGB_RMOD, RGB_SPI
    ),
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    static uint8_t  current_hue     = 10;
    if (host_keyboard_led_state().caps_lock) {
		if (timer_elapsed32(cycle_led_timer) > 128) {
            current_hue     = current_hue == 10 ? 50 : 10;
